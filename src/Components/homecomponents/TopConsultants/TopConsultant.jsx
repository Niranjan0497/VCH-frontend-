...
function Specialities() {
  const categories = [
    ...
    { title: "Technology", icon: "🖥", link: "experdetails/IT consulting" },
    { title: "Wellness", icon: "🩺", link: "expertdetails/Dentist" },
  ];
        ...
        >
          {categories.map((item, index) => (
            ...
            >
              ...
              {/* ✅ Navigate link on "Explore Now" */}
              <Link to={item.link} className="mt-2">
                <span className="text-blue-600 text-sm sm:text-base font-medium flex items-center gap-1 group">
                  EXPLORE NOW
                  <svg
