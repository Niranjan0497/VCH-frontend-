  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2
          className="text-black text-3xl font-bold mb-6 tracking-widest"
          style={{
            // "font-family": "Teko",
        ...
        <form className="space-y-8" onSubmit={handleSubmit}>
          ...
          <div className="relative">
            <FaEnvelope className="absolute left-3 top-5 text-black transition-all peer-focus:top-2" />
            <input
              id="email"
              name="email"
              type="email"
            ...
            <label
              htmlFor="email"
              className={`absolute left-10 tracking-widest text-black text-sm transition-all ${formData.email ? "top-2 text-sm" : "top-5 text-base peer-placeholder-shown:top-5 peer-placeholder-shown:text-base peer-focus:top-2 peer-focus:text-sm"}`}
            >
              Email ID
            </label>
          </div>
          ...
          {/* Password Input */}
          <div className="relative">
            <FaLock className="absolute left-3 top-5 text-black transition-all peer-focus:top-2" />
            <input
              id="password"
              name="password"
              type="password"
            ...
            <label
              htmlFor="password"
              className={`absolute tracking-widest left-10 text-black text-sm transition-all ${formData.password ? "top-2 text-sm" : "top-5 text-base peer-placeholder-shown:top-5 peer-placeholder-shown:text-base peer-focus:top-2 peer-focus:text-sm"}`}
            >
              Password
            </label>
          </div>
          ...
          <div className="flex items-center justify-between text-black text-sm">
            ...
            <Link
              to="#"
              className="hover:underline italic font-semibold text-sm tracking-wide"
            >
              Forgot Password?
            </Link>
          </div>
        ...
        <p className="mt-4 text-center text-sm text-black font-semibold">
          ...
          <Link
            to="/register"
            className="font-bold  text-gray-900 hover:text-blue-200"
          >
            Register
          </Link>
