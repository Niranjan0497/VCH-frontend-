          ...
          <div className="flex items-center space-x-4 sm:space-x-6 md:space-x-8">
            ...
            <div className="hidden md:flex items-center space-x-2 lg:space-x-6">
              ...
              <div className="relative group ">
                <button className="flex items-center text-white font-semibold text-sm sm:text-base lg:text-lg pb-1 hover:font-bold">
              ...
              <Link
                to="/video-consult"
                className={`text-white font-semibold text-sm sm:text-base lg:text-lg pb-1 hover:font-bold ${
