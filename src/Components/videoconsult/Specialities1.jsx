    ...
    <div className="max-w-6xl overflow-hidden mx-auto p-4">
      <div className="mb-12">
        <div className="flex justify-between items-end mb-6">
          <div>
            <h2 className="text-3xl font-bold text-gray-800 mb-2">25+ Specialities</h2>
            <p className="text-gray-600">Consult with top doctors across specialities</p>
          </div>
          <button className="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-[#2DAA9E] hover:text-white" onClick={()=>navigate("/newpage")}>
