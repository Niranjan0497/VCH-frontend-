...
const ExpertManagement = () => {
  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-lg">
      ...
      {showNewlyRegistered && newlyRegistered.length > 0 && (
        <div className="mb-6 bg-gray-50 p-4 rounded-lg shadow-sm">
          ...
          <div className="overflow-x-auto">
            {/* Header row */}
            <div className="grid grid-cols-5 bg-gray-100 text-gray-700 text-left rounded-t-lg">
              <div className="p-3 font-medium">Name</div>
              <div className="p-3 font-medium">Email</div>
              <div className="p-3 font-medium">Specialization</div>
              <div className="p-3 font-medium">Registration Date</div>
              <div className="p-3 font-medium">Actions</div>
            </div>
            
            {/* Data rows */}
            {newlyRegistered.map((expert) => (
              <div key={expert.id} className="grid grid-cols-5 hover:bg-gray-50">
                <div className="p-3">{expert.name}</div>
                <div className="p-3">{expert.email}</div>
                <div className="p-3">{expert.specialization}</div>
                <div className="p-3">{expert.registrationDate}</div>
                <div className="p-3">
                  <button 
      ...
      <div className="overflow-x-auto">
        {/* Header row */}
        <div className="grid grid-cols-6 bg-gray-100 text-gray-700 text-left rounded-t-lg shadow-md">
          <div className="p-3 font-medium">Name</div>
          <div className="p-3 font-medium">Visited Clients</div>
          <div className="p-3 font-medium">Joined At</div>
          <div className="p-3 font-medium">Verification</div>
        ...
        {paginatedCustomers.map((customer, index) => (
          <div key={customer.id} className={`grid grid-cols-6 hover:bg-gray-50 shadow-sm ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
            <div className="p-3">{customer.name}</div>
            <div className="p-3">{customer.visitedClients}</div>
            <div className="p-3">{customer.joined}</div>
            <div className="p-3">{customer.verification}</div>
            <div className="p-3">
              <button
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2 rounded-md p-3 bg-gray-50">
                {selectedExpert.documents.map((doc, index) => (
                  <div key={index} className="flex items-center justify-between p-2 rounded bg-white hover:bg-blue-50 transition-colors duration-200">
